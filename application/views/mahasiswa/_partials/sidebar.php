<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin_mahasiswa'); ?>">
          <i class="fas fa-fw fa-graduation-cap"></i>
          <span>Mahasiswa</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin_dosen'); ?>">
          <i class="fas fa-fw fa-user"></i>
          <span>Dosen</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin_jadwal'); ?>">
          <i class="fas fa-fw fa-book"></i>
          <span>Jadwal Kuliah</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin/jurusan'); ?>">
